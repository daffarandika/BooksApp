...
<form action="{{ url('books') }}" method='post'>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='author' id="author" value="{{ Session::get('author') }}">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="release" class="col-sm-2 col-form-label">Release Date</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" name='release' id="release" value="{{ Session::get('author') }}">
            </div>
        </div>
        <div class="mb-3 row">
